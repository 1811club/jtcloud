					...
					<ul>
						<li>
							...
							<div class="txt">
								...
								<p>
									<a href="ServletTeacherInfo" target="mainRight">查询个人信息</a>
								</p>
								<p>
									<a href="ServletselectTeacherInfo" target="mainRight">修改个人信息</a>
								</p>
							</div></li>
						<li>
							<div class="t">
							...
							<div class="txt">
								<p>
									<a href="ServletTeaAllCos" target="mainRight">课程信息查看</a>
								</p>
								<p>
						...
						<li>
							...
							<div class="txt">
								<p>
									<a href="ServletTeaStuScore" target="mainRight">成绩信息查看</a>
								</p>
								<p>
